...
const Banner = ({orderTotal, cookingTotal, readyTotal}) => {
  return (
    <div className="w-11/12 mx-auto py-10 grid lg:grid-cols-3 grid-cols-1 gap-5">
      {/* total order */}
      ...
      <div className="border-4 border-dotted rounded-2xl border-amber-400 p-5">
        <div className="flex flex-col lg:flex-row items-center justify-between">
          <Heater className="animate-pulse" color="#fcb700" size={100}></Heater>
          <div className="text-xl text-center">
            Current Cooking
